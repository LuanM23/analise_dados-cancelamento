...
# descobrimos aqui que a média de cancelamentos é 1, ou seja, praticamente todos os contratos mensais cancelaram

# analisando sem o contrato mensal
...
#criando gráficos para melhor visualizar
